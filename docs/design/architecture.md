...
| The server keeps **no** Yorkie `Watch` subscription (ADR-002) | Load-test baseline *numbers* (SRS §2.4) — how to measure them is settled in [`PERFORMANCE-QUANTIFICATION-CRITERIA.md`](../../PERFORMANCE-QUANTIFICATION-CRITERIA.md) |
