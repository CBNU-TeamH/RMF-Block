...
- [ ] Define block Lock (occupancy): how it is acquired and released, and whether a block held by another user can be edited. `docs/SRS-ko.md` requires the state (`FR-022-06`) but never defines it.
